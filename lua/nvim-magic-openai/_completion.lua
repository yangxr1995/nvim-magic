...
function completion.new_codebase_gen_file_request(prompt, clarify, files, file, model, max_tokens, stops)
   ...
   "'" .. file.name .. "'." ..
   "\n\nSince you are writing directly to the file system, an empty file with the name " .. file.name .. " has been created. Your output will feed directly to this file, so answer only with the file content and nothing else (no additional formating or meta data). If you are writing code, make sure that your code correctly imports whatever libraries used. Answer only with the plain file content and don't embedd the code inside backticks."
